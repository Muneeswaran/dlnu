  ...
  <tr>
    ...
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	你好<span class="username"><%=session.getAttribute("userName") %></span>欢迎使用后台管理系统
        	[<a href="PageInfoActionfirstPage" target="_blank">网站主页</a>]
        	[<a href="QuitAction" target="adminIndex.html">注销用户</a>]&nbsp;
      </td>
      </tr>
      <tr>
