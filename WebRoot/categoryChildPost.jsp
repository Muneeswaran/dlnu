...
<li><div class="title"><a href="PageInfoActionreadTopicPage?topicId=<s:property value="#topic.getId()"/>&&commentPageNum = 1" target="_black"><s:property value="#topic.getTitle()"/></a></div>
...
<script type="text/javascript">
	 ...
	 var categoryChildId = <s:property value="pageInfoVo.getCategoryChildId()"/>;
	 if(size < size1){
	   	...
	   	for ( i=1; i<=pageNum; i++){
	   		document.write(" <a href='PageInfoActiontoCHTopicList?categoryChildId="
	   							+categoryChildId+
	   							"&&topicPageNum="
	   							+i+
