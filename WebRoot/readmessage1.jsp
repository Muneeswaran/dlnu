...
<div class="bignav" style="background: url(img/sliderbg.jpg);
		...
		<div style="padding:5px;margin-left:190px;font-family:Tahoma, Geneva, sans-serif;font-size:35px;font-weight: bold;">发送的信息</div>
        <div class="container">
...
<div id="main">
    ...
    <center>
    <div id="title"><s:property value="letter.sender.name"/>  TO  <s:property value="letter.receiver.name"/></div>
    </center>
      ...
      <div class="innerNav">
    <a href="UserActiontoPostMessage?reId<s:property value='letter.receiverid'/>"class="tend">回复</a>
    </div><!--.innerNav-->
