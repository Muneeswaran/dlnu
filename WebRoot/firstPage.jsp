...
<!--header end-->
		...
		<!--Content-->
			...
			.search_form{
	position:relative; height:10px; margin:0 auto;display:inline-block;
	} 
.search_form:hover{
...
.sbtn{
	...
	padding:0 12px; 
	margin-left:-1px;  
	border-radius:0 2px 2px 0; border:1px solid #4d90fe;
...
<body><!--header-->
    ...
    <div class="header" id="header">
        ...
        {%>
    <a style="font-size:14px;" href="LoginActiontoLoginPage">登录</a>|<a href="RegisterActiontoRegisterPage">注册</a>
    <%} 
			else {%>
			
		  <a href="PageInfoActiontoPersonCenter?userId=<%=session.getAttribute("userId") %>" style="color:red"><%=session.getAttribute("userName") %>(<s:property value="msCount"/>)</a>
<%--		  <a href="PageInfoActiontoPersonCenter?userId=<%=session.getAttribute("userId") %>" class="welcome">您已登录</a>--%>
		   <a href="QuitAction">注销用户</a>
		<%	}  %>
		<div id ="search" style="margin-left: 300px;margin-top: -20px;">
    		
    		
    		
    		<form action="SearchActiontoAboutAdmin" method="post" class="search_form">     
			<input type="text" name="key" class="sinput" placeholder="输入 回车搜索" >      
                ...
                <ul class="menu">
                    ...
                    <li><a href="">分类</a>
					  ...
					  <s:iterator value="categoryList" id="category" status="st">
                    	<li><a href="PageInfoActionsecondPage?categoryId=<s:property value='#category.id'/>"><s:property value="name"/></a></li>
                    </s:iterator>
                    </ul>
                    </li>
    ...
    <div id="slider" >
    	<div class="slider-pic" style="background:url(img/slider-1.png) no-repeat scroll center center;"></div>
        <div class="slider-pic" style="background:url(img/slider-2.png) no-repeat scroll center center;"></div>
        <div class="slider-pic" style="background:url(img/slider-3.png) no-repeat scroll center center;"><div class="slider-caption"><p>This is some <a href="##">example</a> html caption.</p></div></div>
        <div class="slider-pic" style="background:url(img/slider-4.png) no-repeat scroll center center;"></div>
    </div><!--slider-->
</div><!--pic-holder-->
...
<%--                        <p><s:property value="#news.content" escape="false"/></p>--%>
        ...
        <div class="latestwork">
        	...
        	<div class="recentitems">
       			 <div class="four columns mnm mnm1">
				 	<a href="#" class="glavni"><img width="150" height="88" title="4746951625_cd20f1e0c4_z" alt="4746951625_cd20f1e0c4_z" class="attachment-portfoliohome wp-post-image" src="tupainaaaa/2010081121325186.png" /></a>
				 	<h4><a href="./portfolio-single.html">Port item</a></h4>
				 </div>


                <div class="four columns mnm mnm2">
                 	<a href="#" class="glavni"><img width="150" height="88" title="2876370429_5fa4566a9c_b" alt="2876370429_5fa4566a9c_b" class="attachment-portfoliohome wp-post-image" src="tupainaaaa/2011101920361396.png" /></a>
                 	<h4><a href="./portfolio-single.html">Other Project</a></h4>
                 </div>

                <div class="four columns mnm mnm3">
                    <a href="#" class="glavni"><img width="150" height="88" title="2533740559_2086c0b58b_z" alt="2533740559_2086c0b58b_z" class="attachment-portfoliohome wp-post-image" src="tupainaaaa/2011122919545196.png" /></a>
                    <h4><a href="./portfolio-single.html">HTML Theme</a></h4>
                </div> 
                
                <div class="four columns mnm mnm4">
                    <a href="#" class="glavni"><img width="150" height="88" title="2871105756_7ff68cfe42_b" alt="2871105756_7ff68cfe42_b" class="attachment-portfoliohome wp-post-image" src="tupainaaaa/2011101920361397.png" /></a>
                    <h4><a href="#" style="color: rgb(99, 99, 99);">Awesome site</a></h4>
                </div>
                    
                <div class="four columns mnm mnm4">
                    <a href="#" class="glavni"><img width="150" height="88" title="2871105756_7ff68cfe42_b" alt="2871105756_7ff68cfe42_b" class="attachment-portfoliohome wp-post-image" src="tupainaaaa/2011122919545195.png" /></a>
                    <h4><a href="#" style="color: rgb(99, 99, 99);">Awesome site</a></h4>                                                                                                   
                </div>
                    
                <div class="four columns mnm mnm4">
                    <a href="#" class="glavni"><img width="150" height="88" title="2871105756_7ff68cfe42_b" alt="2871105756_7ff68cfe42_b" class="attachment-portfoliohome wp-post-image" src="tupainaaaa/m_1365316771104.png" /></a>
                    <h4><a href="#" style="color: rgb(99, 99, 99);">Awesome site</a></h4>
                </div>
    ...
    <div class="six columns sidebarhome"><!--right-->
        ...
        <div class="widget">
        <div class="h4bg"><img style="margin-top:-20px; float:left;  "src="img/best.png" /><h4>获奖</h4><h6>（此功能暂未开通，敬请期待）</h6></div>
...
<s:iterator value="topicList" id="topic">
          <li style="width: 300px; overflow: hidden;">
            <a class="thumby" href="PageInfoActiontoFriendCenter?friendId=<s:property value='#topic.user.id'/>"><img src="tupainaaaa/2010081121325186.png" width="50" height="50" alt="" /></a>
            <div class="info">
            <h3 style="width: 200px; overflow: hidden;"><a  href="PageInfoActionreadTopicPage?topicId=<s:property value='#topic.id'/>&&commentPageNum = 1"><s:property value="#topic.title"/></a></h3>
...
<a class="thumby" href="PageInfoActiontoFriendCenter?friendId=<s:property value='#topic.user.id'/>"><img src="tupainaaaa/2011122919545196.png" width="50" height="50" alt="" /></a>
<div class="info">
...
<li style="width: 300px;">
<a class="thumby" href="PageInfoActiontoFriendCenter?friendId=<s:property value='#topic.user.id'/>"><img src="tupainaaaa/m_1365316771104.png" width="50" height="50" alt="" /></a>
<div class="info">
<h3><a href="PageInfoActionreadTopicPage?topicId=<s:property value="#topic.id"/>&&commentPageNum = 1"><s:property value="#topic.title"/></a></h3>
